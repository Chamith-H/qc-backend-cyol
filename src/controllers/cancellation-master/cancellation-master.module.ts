...
import { Cancellation, CancellationSchema } from 'src/schemas/cancellation-master.schema';
import { MongooseModule } from '@nestjs/mongoose';

@Module({
  imports: [
    MongooseModule.forFeature([{ name:Cancellation.name, schema: CancellationSchema }])
  ],
